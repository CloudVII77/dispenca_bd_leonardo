...
update detalhe_pedido set valor = "29.00" where pk = 2;
update pedido set origem = "canadá" where pk = 3;
update lote set quantidade = "7" where pk = 1;

delete from lote where pk = 4;
delete from detalhe_pedido where pk = 1;
delete from pedido where pk = 3;
delete from alimento where pk = 4;
